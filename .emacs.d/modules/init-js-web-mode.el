;;; -*- lexical-binding: t -*-
;;; init-js-web-mode.el --- Use web-mode to edit JS.
...
(-when-let (npm-prefix (init/exec-if-exec "npm" "config get prefix"))
...
(use-package web-mode
  ...
  (with-eval-after-load "flycheck"
    ...
    (setq flycheck-javascript-eslint-executable (or (init/resolve-exec "eslint") "eslint"))))
