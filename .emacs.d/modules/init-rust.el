...
;; (setenv "RUSTC" (init/resolve-exec "rustc"))
...
(use-package cargo
  ...
  (with-eval-after-load "projectile"
    (bind-key "C-c C-s" #'init-rust/save-and-recompile)
    (bind-key "C-c s" #'init-rust/save-all-and-recompile))
...
(defun init-rust/save-and-recompile ()
  (interactive)
  (save-buffer)
...
(defun init-rust/save-all-and-recompile ()
  (interactive)
  (save-some-buffers)
  (when compile-history
    (let ((cmd (car compile-history)))
